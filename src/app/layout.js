...
export const metadata = {
  title: 'ES7 LABS',
  description: 'We specialises on building web solutions for professionals in the entertainment space',
}
          ...
          <footer>
            <div>
              ...
              <div className={Styles.social_media_links}>
                <div>
                  <a>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={Styles.social_media_icon}>
              ...
              <p className={Styles.inquiry}>For general inquiries, contact us at <a className={Styles.email}>hello@es7.com.</a>ES7 LABS,Onitsha,Anambra</p>
              <p>© Copyright 2023 ES7 LABS</p>
            </div>
          </footer>
        </div>
      </body>
